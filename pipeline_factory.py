    ...
    def _create_text_pipeline(
        ...
        match model.provider:
            ...
            case ModelProvider.OPENAI:
                from .pipelines.remote.openai_chat import OpenAIChatModel  # pylint: disable=import-outside-toplevel

                return OpenAIChatModel(model_name=model.name)  # type: ignore[return-value]
            case ModelProvider.ANTHROPIC:
                from .pipelines.remote.anthropic_chat import AnthropicChatModel  # pylint: disable=import-outside-toplevel
